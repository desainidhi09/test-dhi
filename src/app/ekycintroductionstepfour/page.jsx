...
export default function EKYCIntroductionStepFourPage() {
  const [searchBarValue62, setSearchBarValue62] = React.useState("");
          ...
          <header className="bg-white-A700 flex items-center justify-center w-full">
            <div className="flex flex-row items-center justify-center mx-auto my-2.5 w-[96%]">
              ...
              <Input
                name="SearchBox"
                placeholder="Search..."
                value={searchBarValue62}
                onChange={(e) => setSearchBarValue62(e)}
                prefix={
                  <Img
                ...
                suffix={
                  searchBarValue62?.length > 0 ? (
                    <CloseSVG
                      onClick={() => setSearchBarValue62("")}
                      fillColor="#36414fff"
                    />
                  ) : null
                }
                    ...
                    <div className="bg-white-A700 flex flex-row gap-5 items-center justify-start ml-[7px] rounded w-[55%]">
                      <div className="h-[30px] relative w-[13%]">
                        ...
                        <div className="absolute bottom-[-2%] flex flex-col h-4 items-center justify-start m-auto p-px right-[0%] w-4">
                          <div className="bg-white-A700 h-[13px] mb-px outline outline-[0.9px] outline-bluegray-800 p-0.5 relative rounded-md w-[13px]">
                            <Img
