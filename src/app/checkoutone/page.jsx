...
export default function CheckoutOnePage() {
  const [searchBarValue63, setSearchBarValue63] = React.useState("");
          ...
          <header className="bg-white-A700 flex items-center justify-center w-full">
            <div className="flex flex-row items-center justify-center mx-auto my-2.5 w-[96%]">
              ...
              <Input
                name="SearchBox"
                placeholder="Search..."
                value={searchBarValue63}
                onChange={(e) => setSearchBarValue63(e)}
                prefix={
                  <Img
                ...
                suffix={
                  searchBarValue63?.length > 0 ? (
                    <CloseSVG
                      onClick={() => setSearchBarValue63("")}
                      fillColor="#36414fff"
                    />
                  ) : null
                }
          ...
          <div className="bg-gray-51 flex flex-col items-center justify-end p-[23px] w-full">
            <div className="flex flex-col gap-9 items-center justify-start mb-2 mt-3.5 w-[99%]">
              ...
              <div className="flex h-[802px] justify-end relative w-full">
                ...
                <div className="absolute bg-white-A700 bottom-0 flex flex-col gap-[65px] h-full items-center justify-center left-0 m-auto p-[111px] right-0 rounded shadow-sm top-0 w-full">
                  <Img
                    src="images/img_group18037.svg"
                    alt="Group18037"
                    className="h-52"
                  />
                  <div className="flex flex-col gap-8 items-center justify-start mb-[143px] w-[56%]">
                    <div className="flex flex-col gap-2 justify-start w-full">
                      <Text className="!text-bluegray-900 font-bold ml-12 text-2xl">
                        Congratulate! Order successfully
                      </Text>
                      <Text className="!text-bluegray-900 font-normal leading-[22px] text-center text-sm">
                        Your order receipt has been sent to your mail:
                        sambrown@gmail.com. Please check your mail
                      </Text>
                    </div>
                    <Button className="bg-deep_orange-300 font-bold h-12 min-w-[207px] px-[35px] rounded-[24px] text-sm text-white-A700">
                      Review product
                    </Button>
                  </div>
                </div>
