          ...
          <div className="bg-gray-51 flex flex-col items-center justify-end p-[23px] w-full">
            <div className="flex flex-col gap-[35px] items-center justify-start mb-px mt-[15px] w-full">
              ...
              <div className="bg-white-A700 flex flex-col items-center justify-start p-12 rounded shadow-sm w-full">
                ...
                <div className="bg-gray-51 border-2 border-dashed border-indigo-51 flex flex-col items-end justify-end mt-10 p-8 rounded w-[65%]">
                  <div className="flex flex-col gap-9 justify-start mt-[79px] w-[95%]">
                    <Img
                      src="images/img_signatureofka.png"
                      alt="SignatureofKa"
                      className="mr-[47px] object-cover w-[92%]"
                    />
                    <div className="flex flex-row gap-6 justify-end ml-[451px] w-[23%]">
                      <Button className="bg-white-A700 h-[54px] rounded-[50%] shadow-sm w-[54px]">
                        <Img src="images/img_buttonprimary_8.svg" />
                      </Button>
                      <Button className="bg-white-A700 h-[54px] rounded-[50%] shadow-sm w-[54px]">
                        <Img src="images/img_buttonprimary_9.svg" />
                      </Button>
                    </div>
                  </div>
                </div>
                <Button className="bg-deep_orange-300 font-bold h-12 min-w-[270px] mt-[50px] px-[35px] rounded-[24px] text-sm text-white-A700">
                  Finish process
                </Button>
              </div>
            </div>
