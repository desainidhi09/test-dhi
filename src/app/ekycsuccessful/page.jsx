...
export default function EKYCSuccessfulPage() {
  const [searchBarValue60, setSearchBarValue60] = React.useState("");
        ...
        <div className="flex flex-col items-center justify-start w-[84%]">
          <header className="bg-white-A700 flex items-center justify-center w-full">
            <div className="flex flex-row items-center justify-center mx-auto my-2.5 w-[96%]">
              ...
              <Input
                name="SearchBox"
                placeholder="Search..."
                value={searchBarValue60}
                onChange={(e) => setSearchBarValue60(e)}
                prefix={
                  <Img
                ...
                suffix={
                  searchBarValue60?.length > 0 ? (
                    <CloseSVG
                      onClick={() => setSearchBarValue60("")}
                      fillColor="#36414fff"
                    />
                  ) : null
                }
          ...
          <div className="bg-gray-51 flex flex-col items-center justify-end p-[23px] w-full">
            <div className="flex flex-col gap-[35px] items-center justify-start mb-px mt-[15px] w-full">
              ...
              <div className="bg-white-A700 flex flex-col gap-20 items-center justify-start p-[103px] rounded shadow-sm w-full">
                <Img
                  src="images/img_group18034.svg"
                  alt="Group18034"
                  className="h-[215px]"
                />
                <div className="flex flex-col gap-8 justify-start mb-[130px] w-1/2">
                  <div className="flex flex-col gap-[13px] justify-start w-full">
                    ...
                    <Text className="!text-bluegray-900 font-normal ml-[59px] text-sm">
                      Thank for your patient. Your account has been protected
                    </Text>
                  </div>
                  <Button className="bg-deep_orange-300 font-bold h-12 min-w-[207px] ml-[143px] mr-[115px] px-[35px] rounded-[24px] text-sm text-white-A700">
                    Explore product
                  </Button>
                </div>
              </div>
