...
import { Button, Text, Img, Radio, RadioGroup, Input } from "../../components";
import { Sidebar } from "react-pro-sidebar";

export default function CalenderDay1EventPage() {
            ...
            <div className="flex flex-col gap-[38px] items-start justify-start mb-px mt-3.5 w-full">
              ...
              <div className="flex flex-row justify-between w-full">
                  ...
                  <div className="flex flex-col items-start justify-start mb-2 w-full">
                    <div className="flex flex-col gap-6 items-center justify-start">
                      ...
                      <Button
                        ...
                        className="bg-deep_orange-300 font-semibold h-12 pl-[30px] rounded-[24px] text-sm text-white-A700 w-full"
                      >
                        Create new event
                      </Button>
                    </div>
                    <RadioGroup
                      name="radiogroupprofileviewsone2"
                ...
                <div className="bg-white-A700 flex flex-col items-center justify-start p-[26px] rounded shadow-sm w-3/4">
                  <div className="flex flex-col gap-[30px] items-center justify-start mb-1.5 w-[99%]">
                    <div className="flex flex-row justify-between w-full">
                      ...
                      <div className="flex flex-row gap-2 justify-between w-auto">
                        <Button className="bg-bluegray-900 font-semibold h-10 min-w-[75px] px-6 rounded-[20px] text-sm text-white-A700">
                          Day
                        </Button>
                    ...
                    <div className="h-[642px] relative w-full">
                      <div className="border border-indigo-51 border-solid flex flex-col items-center justify-start m-auto p-1 w-full">
                        <div className="bg-indigo-400 flex flex-row items-start justify-start mb-[556px] mt-px p-1 rounded w-full">
                          <Img
                            src="images/img_oval.svg"
                            alt="Oval"
                            className="h-2 ml-3 mt-[7px]"
                          />
                          <Text className="!text-white-A700 font-medium ml-[13px] text-sm">
                            8:10 am
                          </Text>
                          <Text className="!text-white-A700 font-semibold mb-1 ml-[9px] text-sm">
                            Daily meeting with SEO
                          </Text>
                        </div>
                      </div>
                      <Button className="border border-indigo-51 border-solid font-semibold h-12 m-auto px-[34px] text-base text-bluegray-800 w-full z-[1]">
                        Friday
                      </Button>
                    </div>
                  </div>
