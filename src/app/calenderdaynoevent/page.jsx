...
export default function CalenderDayNoeventPage() {
                      ...
                      <Button
                        rightIcon={
                          <Img
                            ...
                            alt="plus"
                            className="ml-[3px] ml-[3px]"
                          />
                        }
                        className="bg-deep_orange-300 font-semibold h-12 pl-[31px] rounded-[24px] text-sm text-white-A700 w-full"
                      >
                        Create new event
                      </Button>
                    </div>
                    <RadioGroup
                      name="radiogroupprofileviewsone1"
                ...
                <div className="bg-white-A700 flex flex-col items-center justify-start p-[26px] rounded shadow-sm w-3/4">
                  <div className="flex flex-col gap-[30px] items-center justify-start mb-1.5 w-[99%]">
                    ...
                    <div className="h-[642px] relative w-full">
                      <div className="border border-indigo-51 border-solid flex flex-col gap-[54px] items-center justify-start m-auto p-[121px] w-full">
                        <Img
                          src="images/img_19.svg"
                          alt="Nineteen"
                          className="h-[119px]"
                        />
                        <Text className="!text-bluegray-400 font-normal mb-40 text-base">
                          No Event. Create new
                        </Text>
                      </div>
