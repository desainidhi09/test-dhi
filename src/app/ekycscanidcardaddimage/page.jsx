...
import { Button, Img, SelectBox, Text, Input } from "../../components";
        ...
        <Sidebar className="!sticky !w-[243px] h-screen overflow-auto top-0">
          <div className="bg-white-A700 flex flex-col gap-9 items-center justify-start p-[29px] w-full">
            ...
            <div className="flex flex-col items-start justify-start mb-[422px] w-[87%]">
              ...
              <div className="flex flex-row items-start justify-between ml-[3px] mt-8 w-[99%]">
                <div className="flex flex-row gap-4 items-start justify-start mt-0.5">
                  <Img
                    src="images/img_icon_5.svg"
                    alt="Icon Two"
                    className="h-5 mb-px w-5"
                  />
                  <Text className="!text-bluegray-400 font-medium mt-1 text-sm">
                    Message
                  </Text>
                </div>
              ...
              <div className="bg-white-A700 flex flex-col items-center justify-start p-8 rounded shadow-sm w-full">
                <div className="flex flex-col items-center justify-start mb-4 mt-5 w-full">
                  ...
                  <SelectBox
                    ...
                    className="bg-white-A700 border border-indigo-51 border-solid font-medium mt-6 pb-[19px] pl-5 pt-5 rounded text-base text-bluegray-800 w-[31%]"
                  />
                  <div className="flex flex-row justify-between mt-10 w-full">
                    <div className="border-2 border-dashed border-indigo-51 flex flex-col items-center justify-start p-[34px] rounded w-1/2">
                      <div className="h-[291px] relative w-full">
                        <Img
                          src="images/img_image5.png"
                          alt="imageFive"
                          className="h-[291px] m-auto object-cover rounded-[16px] w-full"
                        />
                        <Button className="absolute bg-white-A700 bottom-[10%] h-[54px] m-auto right-[6%] rounded-[50%] shadow-sm w-[54px]">
                          <Img src="images/img_buttonprimary_54X54.svg" />
                        </Button>
                      </div>
                    </div>
                    <div className="h-[359px] relative w-1/2">
                      ...
                      />
                      <div className="absolute border-2 border-dashed border-indigo-51 bottom-0 h-[359px] justify-center left-0 m-auto p-16 right-0 rounded top-0 w-full">
                        <Button className="absolute bg-white-A700 h-[54px] ml-auto mt-auto rounded-[50%] shadow-sm w-[54px]">
                          <Img src="images/img_buttonprimary_54X54.svg" />
                        </Button>
                      </div>
                    </div>
